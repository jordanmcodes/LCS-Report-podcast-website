...
The website will follow a simple three button navigation bar. This navigation bar will appear at the top of every page on the website, each button will link to the deisred page you want to access. 
...
**Home page**: The homepage will have the heading at the top of the page underneath the navigation bar, followed by an introduction piece of text, welcoming the viewers to the webiste. Followed by the featured image below, this will be our most recent episode so you're never out of the loop.
